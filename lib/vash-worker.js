...
var tpl4 = vash.compile(
    ...
    'function(pmd) {' +
        '<table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100%;mso-cellspacing:0in;mso-yfti-tbllook:1184;mso-padding-alt:0in 0in 0in 0in"><tbody><tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes"><td style="padding:0in 0in 0in 0in">' +
        '<p style="margin-top:2.0pt;margin-right:0in;margin-bottom:0in;margin-left:0in;margin-bottom:.0001pt"><span style="font-family:&quot;Segoe UI&quot;,sans-serif">@{var type = pmd.isNew ? "http://onenotealerts.herokuapp.com/images/greenHeart.png" : "http://onenotealerts.herokuapp.com/images/redHeart.png";} <img src="@type" /> <a href="@pmd.pageWebUrl"> @pmd.parentNotebook > @pmd.parentSection > @pmd.pageTitle </a></span></p></td></tr></tbody></table>' +
