...
var headerStyle = "font-weight:100; font-size:2rem; color:purple";
...
var tpl4 = vash.compile(
    ...
    '<p style="' + headerStyle + '">Here are the <b>Shared Notes</b> that were updated yesterday.<br> Happy kibitzing!</p>' +
    '<span><img src="http://mywimbo.com/onenotelogo.png" width="50" height="50" style="margin-top:0px;background-color: white;"> <b style="font-weight:100; font-size:2rem; align=center">OneNote Alerts</b></span><br>' +
    '<ul class="termlist">' +
    '@model.forEach(' +
    ' function(t) {' +
