...
var fixupOffset = function (date) {
    return date;
    // Below is not applicable for Heroku deployment since there is no offset to be fixed up
    // Only applies to devfabric deployments (uncomment if needed)
	// date.setHours(date.getHours() - 7);
	// return new Date(date);
}

var markUpHits = function (inputString, termString) {
    var replacement = "<span style='background-color: #FFFF00'>$&</span>";
    return inputString.replace(new RegExp(termString, 'gi'), replacement);
}
...
var tpl4 = vash.compile(
    ...
    '<body>' +
        ...
        '<p style="margin:0in;margin-bottom:.0001pt"><img src="http://mywimbo.com/onenotelogo.png" width="75" height="75" style="align:center;margin-top:0px;background-color: white;"><span style="align:center;font-size:21pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#1570A6">OneNote Daily Shared Notes Alerts</span></p>' +
    ...
    'function(pmd) {' +
        '<table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100%;mso-cellspacing:0in;mso-yfti-tbllook:1184;mso-padding-alt:0in 0in 0in 0in"><tbody><tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes"><td style="padding:0in 0in 0in 0in">' +
        '<p style="margin-top:2.0pt;margin-right:0in;margin-bottom:0in;margin-left:0in;margin-bottom:.0001pt"><span style="font-family:&quot;Segoe UI&quot;,sans-serif">@if (pmd.isNew) { <font color="green">&#10084;</font> } <a href="@pmd.pageWebUrl"> @pmd.parentNotebook > @pmd.parentSection > @pmd.pageTitle </a></span></p></td></tr></tbody></table>' +
       '@pmd.paragraphs.forEach( function(paramd) { ' +
           ...
           '<p style="margin-top:1pt;margin-right:0in;margin-bottom:0in;margin-left:0in;margin-bottom:.0001pt"><span style="font-size:8pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#111111">  was last modified by <em>@paramd.author</em>  </span><span style="font-size:8pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#999999"> &#8226; </span>' + 
       ...
       '@pmd.images.forEach( function(paramd) { ' +
           '<table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100%;mso-cellspacing:0in;mso-yfti-tbllook:1184;mso-padding-alt:0in 0in 0in 0in"><tbody><tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes"><td style="padding:0in 0in 0in 0in">' +
           '<div style="margin-top:1pt;margin-right:0in;margin-bottom:0in;margin-left:0in;margin-bottom:.0001pt;font-size:10pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#444444"><img src="@paramd.publicUrl" width="50" height="50" style="vertical-align:middle;margin-top:0px;background-color: white;"><span style="vertical-align:middle">Found an image containing : @html.raw(paramd.text) … </span></div>' +
           '<p style="margin-top:1pt;margin-right:0in;margin-bottom:0in;margin-left:0in;margin-bottom:.0001pt"><span style="font-size:8pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#111111">  was last modified by  <em>@paramd.author</em>  </span><span style="font-size:8pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#999999"> &#8226; </span>' + 
           '<span style="font-size:8pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#111111">  @paramd.lastModifiedTime  </span><span style="font-size:8pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#999999"> &#8226; </span></p>' +
           '</td></tr></tbody></table>})' +
    '})' +
                    ...
                    if (apiJson[i].pages.hasOwnProperty(j)) {
                        ...
                        for (var k in apiJson[i].pages[j].images) {
                            if (apiJson[i].pages[j].images.hasOwnProperty(k)) {
                                ...
                                apiJson[i].pages[j].images[k].text = markUpHits(apiJson[i].pages[j].images[k].text, apiJson[i].name);
                            }
                        }
                    }
                }
