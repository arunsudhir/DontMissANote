...
var OneNoteApi = function() {
	...
	function buildHttpOptions(accessToken, url, contentType, body, queryOptions) {
	...
	this.getPages = function (accessToken, callback, queryOptions) {
		...
		queryOptions.top = 500; // Get max number of pages!
		var options = buildHttpOptions(accessToken,
				oneNotePagesApiUrl,
				"application/json",
				null,
	...
	this.getPageJsonContent = function (accessToken, callback, pageId, queryOptions) {
